...
const Card: React.FC<Props> = (props) => {
  ...
  // This condition is to detect whether the place is natural or man made location
  let dateText;
    ...
    <div className='card'>
      ...
      <div className='card--info'>
        <div className='card--location--data'>
          ...
          <a href={props.googleMapsUrl} className='card--maps' target='_blank' rel='noreferrer'>
            View on Google Maps
          </a>
        </div>
